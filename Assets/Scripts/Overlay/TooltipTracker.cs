...
namespace EVRC
{
    ...
    public class TooltipTracker : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            TrackedPoseDriver trackedPoseDriver = GetComponentInParent<TrackedPoseDriver>();
            //var trackedHand = GetComponentInParent<TrackedHand>();
            //var isRight = trackedHand.hand == ActionsController.Hand.Right;
            var isRight = XRRigUtils.GetHand(trackedPoseDriver.poseSource) == ActionsController.Hand.Right;
