    ...
    public class PostBuildExportDocumentation : IPostprocessBuildWithReport
    {
        ...
        public void OnPostprocessBuild(BuildReport report)
        {
            ...
            foreach (var filename in DocFiles)
            {
                ...
                Debug.LogFormat("Coppied {0} to root as html/md", filename);
            }
            ...
            foreach ((string fromPath, string toName) in SpecialFiles)
            {
                ...
                Debug.LogFormat("Coppied {0} as {1}/.html to root", fromPath, toName);
            }
            ...
            foreach (var imagePath in imagePaths)
            {
                ...
                Debug.LogFormat("Coppied {0} to Images", Path.GetFileName(imagePath));
            }
        }
    }
}
